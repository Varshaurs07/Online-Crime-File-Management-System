...
<head>
    ...
    <title> ONLINE CRIME FILE MANAGEMENT SYSTEM - Forgot Password</title>
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-md-6 d-flex align-items-center">
                                <div class="card-body p-md-5 py-4 mx-md-4 mx-2">
                                    ...
                                    <form method="post" action="sendemail.php" id="userloginform">


                                        <div class="input-group mb-4 position-relative">
                                            <span class="input-group-text" id="basic-email"><i class="fa-solid fa-user"></i></span>
                                            <input type="text" name="email" id="email" class="form-control shadow-none border-secondary-subtle" placeholder="Your Email" aria-label="Email" aria-describedby="basic-email">
                                        ...
                                        <div class="text-center pt-1 pb-1 ">
                                            <button class="btn btn-outline-danger  w-100 shadow-none" type="submit">Submit</button>
                                        </div>

                                        <div class="text-center d-flex justify-content-center gap-2 pt-4">
