...
<body>
            ...
            <div class="container-fluid  mx-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0 gap-1">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-white fw-bold text-decoration-underline link-offset-2 active" aria-current="page" href="missingpersons.php">
                                <i class="fa-solid fa-list"></i>
        ...
        <div class="container flex-fill d-flex flex-column my-2">
            ...
            <div class="row justify-content-center my-2">
                ...
                <div class="col-md-12">
                        ...
                        <table class="table table-bordered table-hover" id="usertable">
                            <thead class="text-white">
                                <tr class="align-middle text-center text-nowrap table-danger">
                                    ...
                                    <th class="dt-head-center">Age</th>
                                    <th class="dt-head-center">Notify</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php
                                $query = "select * from crime_2023_missingperson";
                    ...
                    <?php
                    $querytask = "SELECT * FROM crime_2023_missingperson";
                    ...
                    ?>
                            ...
                            <div class="modal fade" id="edit<?= $rowtask["uid"] ?>" tabindex="-1" aria-labelledby="edit<?= $rowtask["uid"] ?>Label" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                    <form action="updatemissingperson.php" method="post" class="updatemissingpersonform">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit" value="<?= $rowtask["uid"] ?>" name="updatemissingperson" class="btn btn-success shadow-none">Update Changes</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
    ...
    <script>
        $(function() {
            ...
            $(".updatemissingpersonform").on("submit", function(e) {
