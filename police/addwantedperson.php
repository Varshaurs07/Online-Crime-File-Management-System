...
<body>
            ...
            <div class="container-fluid  mx-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0 gap-1">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-white fw-bold text-decoration-underline link-offset-2 active" aria-current="page" href="addwantedperson.php">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-white fw-bold" aria-current="page" href="addmissingperson.php">
                                <i class="fa-solid fa-user-plus"></i>
        ...
        ?>
            <div class="position-fixed top-0 toastae start-50 translate-middle-x p-3" style="z-index: 11">
                <div id="liveToast" class="toast bg-success bg-opacity-75 hide" role="alert" aria-live="assertive" aria-atomic="true">
                    <div class="d-flex">
                        <div class="toast-body ms-auto text-white">
                        Wanted Person Added Successfully !
                        </div>
                        <button type="button" class="btn-close shadow-none btn-close-white me-2 m-auto" data-bs-dismiss="toast" aria-label="Close"></button>
                    </div>
                </div>
        ...
        <div class="container flex-fill d-flex flex-column my-2">
            ...
            <div class="row justify-content-center my-2">
                ...
                <div class="col-md-12">
                    ...
                    <form action="savewantedperson.php" method="post" id="savewantedpersonform" autocomplete="off" enctype="multipart/form-data">
                        ...
                        <div class="row justify-content-around g-3">
                            ...
                            <div class="col-md-5 position-relative">
                                <label for="crimedate" class="form-label">Crime Added Date:</label>
                                <input type="date" name="crimedate" id="crimedate" class="form-control shadow-none border-secondary " placeholder="Crime Added Date">
                                <div class="invalid-tooltip rounded-3">
                                    * Enter Crime Added Date
                                </div>
                            </div>   
                            ...
                            <div class="col-md-5 mt-4-5">
                                <button type="submit" name="savewantedperson" class="btn btn-primary shadow-none w-100">Submit</button>
                            </div>
    ...
    <script>
        $(function() {
            ...
            $("#savewantedpersonform").on("submit", function(e) {
                debugger;
                ...
                if (crimedate != "") {
                    $("#crimedate").removeClass("is-invalid");
                } else {
                    $("#crimedate").addClass("is-invalid");
                    e.preventDefault();
                }
